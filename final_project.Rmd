...
ggplot(regression_points, aes(x = region, y = residual)) +
  geom_point() +
  labs(x = "Total Volume (in millions)", y = "Residual") +
  geom_hline(yintercept = 0, col = "blue", size = 1)

```
From both graphs, we observe that the spread of the residuals increases as the value of total volume increases. Thus, any inference for regression based on this model is not valid because it yields such a pattern. 
