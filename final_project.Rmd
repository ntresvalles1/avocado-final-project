...
We selected the interaction model, as there are slopes of the lines in the plots of the interaction model that we believe merits the additional complexity.
...
\widehat{y} = 
1.58195 
+ -7.57343e^{-8} \cdot \text{total_volume}  
+ 0.06963 \cdot \mathbb{1}_{\text{is Plains}}(x)
- 0.10706 \cdot \mathbb{1}_{\text{is West}}(x)
- 2.23568^{-7} \cdot \text{total_volume} \cdot \mathbb{1}_{\text{is Plains}}(x)
- 1.30082^{-8} \cdot \text{total_volume} \cdot \mathbb{1}_{\text{is West}}(x)
